...
export const saleStatus = [
  ...
  { id: 'cancelada', status: "Cancelada", color: 'red_600' },
  { id: 'reembolsada', status: "Reembolsada", color: 'blue_700' },
  { id: 'problema', status: "Problema", color: 'orange_600' },
  { id: 'entregue', status: "Entregue", color: 'teal_500' },
